...
Constantes.setHorarioActual(LocalTime.now());
        ...
        <div class="container" style="padding-top: 50px" >
            ...
            <h1 class="align-content-lg-center"><strong>Gerentes Registrados en el Sistema</strong></h1>
            <h3 class="align-content-lg-center">Campos de Busqueda:</h3>

            <FORM class="col-12 caja2" METHOD="GET" ACTION="VisualizarGerentes">  
                <div class="row">
                    <div class="form-group col-md-3">
                        <label for="codigoUsuario">Buscar por Codigo de Usuario: </label>
                        <input class="form-control" type="number"  name="codigoUsuario" id="codigoUsuario" placeholder="Ingrese el Codigo del Gerente">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="nombreUsuario">Buscar por Nombre: </label>
                        <input class="form-control" type="text"  name="nombreUsuario" id="nombreUsuario" placeholder="Ingrese el Nombre del Gerente">
                    </div>
                     <div class="form-group col-md-3">
