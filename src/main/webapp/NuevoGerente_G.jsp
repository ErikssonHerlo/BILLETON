...
Constantes.setHorarioActual(LocalTime.now());
        ...
        <div class="container" style="padding-top: 50px" >
            ...
            <h1 class="align-content-lg-center"><strong>Registrar Nuevo Gerente</strong></h1>

            <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevoGerente">  
                <h3 class="align-content-lg-center">Datos del Gerente</h3>
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="nombreUsuario">Nombre:</label>
                        <input class="form-control" type="text"  name="nombreUsuario" id="nombreUsuario" placeholder="Ingrese el Nombre del Gerente" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="DPIUsuario">DPI: </label>
                        <input class="form-control" type="number"  name="DPIUsuario" id="DPIUsuario" placeholder="Ingrese el DPI del Gerente" required>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4">
                        <label for="direccionUsuario">Dirección: </label>
                        <input class="form-control" type="text"  name="direccionUsuario" id="direccionUsuario" placeholder="Ingrese la Dirección del Gerente" required>
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="password"  name="passwordUsuario" id="passwordUsuario" placeholder="Ingrese la Contraseña Asignada al Gerente" required>
                    </div>
                    <div class="form-group col-md-4">
        ...
        <div class="container" style="padding-top: 70px" >
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <h3><strong>Codigo del Gerente: </strong></h3>
                    <h4>${informeRegistro.codigo}</h4>
                </div>
                <div class="form-group col-md-4">
                    <h3><strong>Nombre del Gerente: </strong></h3>
            ...
            <div class="alert alert-danger">
                Error al Agregar al Gerente, Complete los Campos Obligatorios
            </div>
            <div class="col-12 caja2">
                <CENTER>

                    <a href="NuevoGerente_G.jsp" class="btn btn-primary">Ingresar Datos de Nuevo</a>
