 ...
 */
@WebServlet(name = "NuevoDeposito", urlPatterns = {"/NuevoDeposito"})
public class NuevoDeposito extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
         AccesoADeposito acceso = new AccesoADeposito();
        ...
        switch (action) {
           ...
           case "confirmarTransaccion":
               ...
               Transaccion nuevoDeposito = new Transaccion(codigoTransaccion, numeroCuenta, "", "", "Credito", monto, codigoCajero);
               
               if(acceso.realizarDeposito(nuevoDeposito)){
                        request.setAttribute("InformeTransaccion", true);
                        request.setAttribute("Informe", acceso.informeDeposito(codigoTransaccion, nombre));
        ...
        RequestDispatcher despachar = request.getRequestDispatcher("RealizarDeposito_Ca.jsp");
