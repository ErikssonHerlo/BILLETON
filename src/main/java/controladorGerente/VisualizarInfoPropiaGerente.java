 ...
 */
@WebServlet(name = "VisualizarInfoPropiaGerente", urlPatterns = {"/VisualizarInfoPropiaGerente"})
public class VisualizarInfoPropiaGerente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int codigoUsuario = (int)request.getSession().getAttribute("codigoUsuario");
            request.setAttribute("Usuario", acceso.obtenerGerenteAEditar(codigoUsuario));

        RequestDispatcher despachar = request.getRequestDispatcher("VisualizarInfoPropiaGerente_G.jsp");
