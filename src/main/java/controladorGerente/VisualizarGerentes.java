...
public class VisualizarGerentes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       //SI INGRESO TODOS LOS DATOS ADECUADAMENTE, PROCEDEMOS A REGISTRARLOS 
            ...
            AccesoAVisualizacionGerentes acceso = new AccesoAVisualizacionGerentes();
             ...
             if(!codigoUsuarioBusqueda.equals("") && nombre.equals("") && turno.equals(""))
             {
                 ...
                 request.setAttribute("Reporte", acceso.busquedaGerentesCodigo(codigoUsuario));
                 
             } else if(codigoUsuarioBusqueda.equals("") && !nombre.equals("") && turno.equals(""))
             {
                 System.out.println("Busqueda solo por Nombre");
                 request.setAttribute("Reporte", acceso.busquedaGerentesNombre(nombre));
             } else if(codigoUsuarioBusqueda.equals("") && nombre.equals("") && !turno.equals(""))
             {
                 System.out.println("Busqueda solo por Turno");
                 request.setAttribute("Reporte", acceso.busquedaGerentesTurno(turno));
             }  else if(!codigoUsuarioBusqueda.equals("") && !nombre.equals("") && turno.equals(""))
             {
                 System.out.println("Busqueda por Codigo y Nombre");
                 codigoUsuario = Integer.parseInt(request.getParameter("codigoUsuario"));
                 request.setAttribute("Reporte", acceso.busquedaGerentesC_N(codigoUsuario, nombre));
                 
             }else if(!codigoUsuarioBusqueda.equals("") && nombre.equals("") && !turno.equals(""))
             {
                 System.out.println("Busqueda por Codigo y Turno");
                 codigoUsuario = Integer.parseInt(request.getParameter("codigoUsuario"));
                 request.setAttribute("Reporte", acceso.busquedaGerentesC_T(codigoUsuario, turno));
                 
             } else if(codigoUsuarioBusqueda.equals("") && !nombre.equals("") && !turno.equals(""))
             {
                 System.out.println("Busqueda por Nombre y Turno");
                 
                 request.setAttribute("Reporte", acceso.busquedaGerentesN_T(nombre, turno));
                 
             }else if(!codigoUsuarioBusqueda.equals("") && !nombre.equals("") && !turno.equals(""))
             {
                 System.out.println("Busqueda por Codigo, Nombre y Turno");
                 codigoUsuario = Integer.parseInt(request.getParameter("codigoUsuario"));
                 request.setAttribute("Reporte", acceso.busquedaGerentesC_N_T(codigoUsuario, nombre, turno));
                 
             }  else {
             
                 System.out.println("Busqueda General");
                 request.setAttribute("Reporte", acceso.busquedaGeneralGerentes());
                 
             }
           
                  
        RequestDispatcher despachar = request.getRequestDispatcher("VisualizarGerentes_G.jsp");
