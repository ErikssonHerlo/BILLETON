 ...
 */
@WebServlet(name = "VerReporte3Gerente", urlPatterns = {"/VerReporte3Gerente"})
public class VerReporte3Gerente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       double limiteReporte = reportar.obtenerLimiteReporte3(codigoUsuario);
            ...
            request.setAttribute("Reporte", reportar.reporte3Gerente(limiteReporte));
        RequestDispatcher despachar = request.getRequestDispatcher("Reporte3_Gerente.jsp");
