 ...
 */
@WebServlet(name = "VerReporte4Gerente", urlPatterns = {"/VerReporte4Gerente"})
public class VerReporte4Gerente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         AccesoAReporte4_Gerente reportar = new AccesoAReporte4_Gerente();
            request.setAttribute("Reporte", reportar.reporte4Gerente());
        RequestDispatcher despachar = request.getRequestDispatcher("Reporte4_Gerente.jsp");
