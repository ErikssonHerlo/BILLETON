...
<html lang="es">
    ...
    %>
        ...
        %>
        <% RequestDispatcher despachar = request.getRequestDispatcher("VerReporte3Gerente");
           despachar.forward(request, response);%>
        <% } else {
        %>
        <div class="container" style="padding-top: 50px" >

            <h1 class="align-content-lg-center"><strong>Clientes con transacciones Monetarias Sumadas Mayores a un Límite establecido de: Q. ${limiteReporte}</strong></h1>
            <br>
            ...
            <c:choose>
                <c:when test="${Reporte.isEmpty()}">
                    <div class="alert alert-danger">
                        No se encontro a Ningun Cliente con Transacciones Sumadas Mayores al Limite Establecido
                    </div>
                </c:when>
                <c:otherwise>
                    ...
                    <table class="table table-bordered table-hover" >
                        <thead>
                            <tr>
                                ...
                                <th>Nombre</th>
                                <th>Suma Total de Transacciones</th>
        ...
        <br>
         ...
         <CENTER>
                    ...
                    <a href="ExportarReporte3Gerente" class="btn btn-success">Exportar Reporte</a>
