...
<html lang="es">
    ...
    <body>
        ...
        <div class="container" style="padding-top: 50px" >
            ...
            <h1 class="align-content-lg-center"><strong>Registrar Nueva Cuenta Bancaria</strong></h1>

            <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevaCuentaBancaria">  
                <div class="row">
...
<h3 class="align-content-lg-center">Datos del Cliente</h3>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="number"  name="codigoUsuario" id="codigoUsuario" placeholder="Ingrese el Codigo de Usuario del Cliente" required>
                    </div>
                    <div class="form-group col-md-4">
        ...
        <div class="container" style="padding-top: 70px" >
            ...
            <div class="alert alert-success">
                Cuenta Bancaria Agregada con Exito
            </div>
            <h2 class="align-content-lg-center">Informe de la Cuenta Bancaria Creada</h2>
            <div class="row">
                
                    <div class="form-group col-md-4">
                        <h3><strong>Codigo del Cliente Propietario: </strong></h3>
            ...
            <div class="alert alert-danger">
                Error al Agregar la Cuenta Bancaria, Ingrese los Datos Correctamente
            </div>
            <div class="col-12 caja2">
                <CENTER>

                    <a href="NuevaCuentaBancaria_G.jsp_G.jsp" class="btn btn-primary">Ingresar Datos de Nuevo</a>
