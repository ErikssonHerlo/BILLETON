    ...
    <body>
       ...
       {  %>
        ...
        <div class="container" style="padding-top: 50px" >
            ...
            <h1 class="align-content-lg-center"><strong>Nueva Tranferencia entre Cuentas Propias</strong></h1>

            <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevaTransferenciaPropia">  
                <div class="row">
                    <div class="form-group col-md-3">
                <h3 class="align-content-lg-center">Datos de la Cuenta Bancaria de Origen</h3>
                    </div>
                    <div class="form-group col-md-3">
                <h3 class="align-content-lg-center">Datos de la Transferencia</h3>
                </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-3">
                        <label for="numeroCuenta">Número de Cuenta Origen:</label>
                        <select class="form-control" name="numeroCuentaOrigen" id="numeroCuentaOrigen" required>
                            <option value="" selected>Elija una Cuenta de Origen</option>
                            <c:forEach var="resultado" items="${cuentas}">
                                <option value="$resultado.noCuenta">"$resultado.noCuenta" - "$resultado.nombre"</option>
                            </c:forEach>
                        </select>      
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control" name="numeroCuentaDestino" id="numeroCuentaDestino" required>
                            <option value="" selected>Elija una Cuenta de Destino</option>
                            <c:forEach var="resultado" items="${cuentas}">
                                <option value="$resultado.noCuenta">"$resultado.noCuenta" - "$resultado.nombre"</option>
                            </c:forEach>
                        </select>      
