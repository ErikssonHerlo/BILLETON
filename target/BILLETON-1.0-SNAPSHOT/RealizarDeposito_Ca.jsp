...
<html lang="es">
    ...
    %>
        ...
        <div class="container" style="padding-top: 50px" >
            ...
            <h1 class="align-content-lg-center"><strong>Nuevo Depósito</strong></h1>

            <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevoDeposito">  
                <div class="row">
                    <div class="form-group col-md-4">
                <h3 class="align-content-lg-center">Datos de la Cuenta Bancaria</h3>
                    </div>
                    <div class="form-group col-md-4">
                <h3 class="align-content-lg-center">Datos del Deposito</h3>
                </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        <label for="montoTransaccion">Monto de Depósito: </label>
                        <input class="form-control"  type="number" step="0.01" min="25.00" name="montoTransaccion" id="montoTransaccion" placeholder="Ingrese el Monto de Depósito" required>
                    </div>
        ...
        <div class="container" style="padding-top: 70px" >
            <h1 class="align-content-lg-center"><strong>Confirmación del Depósito</strong></h1>
            <% if ((boolean) request.getAttribute("Exitoso")) {%>
             ...
             <FORM class="col-12 caja2" METHOD="POST" ACTION="NuevoDeposito">  
                ...
                <CENTER>
                    ...
                    <a class="btn btn-danger" href="RealizarDeposito_Ca.jsp">Cancelar</a>
            ...
            <div class="col-12 caja2">
                <CENTER>
                    ...
                    <a href="RealizarDeposito_Ca.jsp" class="btn btn-primary">Ingresar Datos de Nuevo</a>
        ...
        <div class="container" style="padding-top: 60px" >
            <h1 class="align-content-lg-center"><strong>Informe del Depósito</strong></h1>
         <% if ((boolean) request.getAttribute("InformeTransaccion")) {%>
            
         
            <br>
            <div class="alert alert-success">
               Depósito Realizado con Exito
            </div>
            <div class="row">
